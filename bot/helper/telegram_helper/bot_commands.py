...
class _BotCommands:
    def __init__(self):
        ...
        self.HelpCommand = f'xyzhelp{CMD_INDEX}'
        ...
        self.SetThumbCommand = f'djshshshs{CMD_INDEX}'
        self.LeechCommand = f'sjshshshs{CMD_INDEX}'
        self.UnzipLeechCommand = f'sjshbsisbsb{CMD_INDEX}'
        self.ZipLeechCommand = f'shshbasvga{CMD_INDEX}'
        self.QbLeechCommand = f'wksbsbsjl{CMD_INDEX}'
        self.QbUnzipLeechCommand = f'majaksbala{CMD_INDEX}'
        self.QbZipLeechCommand = f'plkshsbs{CMD_INDEX}'
        self.LeechWatchCommand = f'vehsinsbe{CMD_INDEX}'
        self.LeechZipWatchCommand = f'snhdhshs{CMD_INDEX}'
